...
%>
		<h1 style="width:75%; margin-left: 140px; color:green;">Welcome User : <%=uid%></h1><br>

		<h3 style="width:75%; margin-left: 140px; color:blue;">Your Details</h3>
		<table style="width:75%; margin-left: 140px; color:red;">
...
<div  style="height:100%; width:50%;position:absolute">
        <h3 style="width:75%; margin-left: 140px; color:blue;">CUSTOMER RATINGS</h3>
		
	<table class="table" style="width:75%; margin-left: 140px; color:red;">
  <thead class="thead-inverse">
    <tr>
      <th>#MovieID</th>
      <th>Movie Title</th>
 ...
 <%
		try{
			...
			bdo1.put("uid", uid);
	 		...
	 		DBCollection coll1 = db.getCollection("user_item_rating");
...
%>
				<tr>
					...
					<td><a href="items.jsp?itemid=<%=itemid%>"><%=obj.get("itemtitle")%></a></td>  						<td><%=rating%></td>
	      			</tr>
<%
			}						
...
<div style="height:100%; width:50%; left:50%;position:absolute">
		<h3 style="width:75%; margin-left: 140px; color:blue;">Hybrid Model Recommendations</h3>
...
%>
				<tr>
      					<th scope="row"><%=itemid%></th>
					<td><a href="items.jsp?itemid=<%=itemid%>"><%=obj.get("itemtitle")%></a></td>
	      			</tr>
<%
			}						
...
<%
		try{
			...
			bdo1.put("uid", uid);
	 		...
	 		DBCollection coll1 = db.getCollection("collaborative");
         		DBCursor cursor1 = coll1.find(bdo1);
    ...
    <%
		try{
			...
			bdo1.put("uid", uid);
	 		...
	 		DBCollection coll1 = db.getCollection("content_based");
         		DBCursor cursor1 = coll1.find(bdo1);
