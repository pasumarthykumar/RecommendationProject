...
A_24 = group A_23 by uid;
A_25 = foreach A_24 { ord = order A_23 by PredictedRating DESC; lim_2 = limit ord 5; generate group as uid,lim_2;};
A_26 = foreach A_25 generate uid,FLATTEN(lim_2);
RecommendedItems = foreach A_26 generate uid,lim_2::itemid as itemid;

store RecommendedItems into 'hdfs://localhost:8020/recommendation/output/hybrid';
